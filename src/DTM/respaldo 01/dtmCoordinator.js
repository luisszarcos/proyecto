    ...
    Coordinator: class Coordinator {
        ...
        start () {
            ...
            return new Promise(function(resolve, reject) {
                ...
                console.log(parentScope.masterServer.pendingLogs);
                var pendingList = parentScope.masterServer.pendingLogs;
                ...
                var attemptToLock = function (parentScope) {
                    ...
                    /*.then( (value) => {
                        console.log("outer: transacction started.");
...
io.on('connection', function ( client ) {
    ...
    client.on('getRoom', function ( clientInfo ) {
        ...
        roomList.set(room, clientInfo.id);
        client.join(room);
